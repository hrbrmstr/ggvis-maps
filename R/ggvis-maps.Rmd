...
See [https://github.com/hrbrmstr/ggvis-maps](https://github.com/hrbrmstr/ggvis-maps) for more info.
...
```{r maine_basic, message=FALSE, warning=FALSE, error=FALSE}
...
```{r maine_labels, message=FALSE, warning=FALSE, error=FALSE}
...
```{r maine_choro, message=FALSE, warning=FALSE, error=FALSE}
...
```{r maine_all_log, message=FALSE, warning=FALSE, error=FALSE}
...
```{r us, message=FALSE, warning=FALSE, error=FALSE}
...
```{r world, message=FALSE, warning=FALSE, error=FALSE}
